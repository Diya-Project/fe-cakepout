...
export default function Detail({ anggaran, confirm }: DetailAttributes) {
    const listDetail = [
        ...
        { icon: <BsGraphUpArrow className='w-20 h-20 text-sky-800 my-auto' />, title: 'Total Realisasi', value: anggaran?.rincian_kegiatan?.total_realisasi && anggaran?.withdraw ? currency(anggaran?.rincian_kegiatan?.total_realisasi) : currency(0) },
